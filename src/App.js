...
function App() {
  return (
    <div className="App" style={{padding:"10%",display:"flex",gap:"3%",rowGap:"1rem",flexWrap:"wrap"}} >
      <div className='firstDiv' >rotation</div>
      <div className='secondDiv' >rotate</div>
      <div className='thirdDiv' >transform</div>
      <div className='fourthDiv' >skewX</div>
      <div className='fifthDiv' >rotateY</div>
      <div className='sixthDiv' >rotateX</div>
